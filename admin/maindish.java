...
//        disableFormFields();
    ...
    public void addProduct() {
        if (validataForm()) {
            ...
            if (maindishBus.addSProduct(sp)) {
                ...
                JOptionPane.showMessageDialog(this, "Them san pham that bai", "Loi", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    private void updateProduct() {
        if (validataForm()) {
            ...
            if (maindishBus.updateProduct(SP)) {
                JOptionPane.showMessageDialog(this, "Cap nhap san pham thanh cong");
                clearForm();
                loadTable("MD1");
                isEditing = false;

            } else {
                JOptionPane.showMessageDialog(this, "Cap nhat san pham that bai!", "Loi", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
        ...
        if (!masp.isEmpty()) {
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                if (maindishBus.deleteProduct(masp)) {
                    ...
                    JOptionPane.showMessageDialog(this, "Xoa san pham that bai", "Loi", JOptionPane.ERROR_MESSAGE);
                }
            }
        } else {
            JOptionPane.showMessageDialog(this, "Vui lòng chọn san pham cần xóa!", "Lỗi", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void searchProductById() {
        ...
        if (!masp.isEmpty()) {
            ...
            if (sp != null) {
                ...
                JOptionPane.showMessageDialog(null, "Không tìm thấy san pham voi ma: " + masp);
            }
        } else {
            loadTable("MD1");
        }
    ...
    public boolean validataForm() {
        if (txtmamon.getText().isEmpty() || !txtmamon.getText().matches("SP\\d+")) {
            JOptionPane.showMessageDialog(this, "Vui long nhap ma san pham", "Loi", JOptionPane.ERROR_MESSAGE);
        ...
        if (txtmaloai.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Vui long nhap ma loai", "Loi", JOptionPane.ERROR_MESSAGE);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btnsua)
                    .addComponent(txttenmon, javax.swing.GroupLayout.DEFAULT_SIZE, 119, Short.MAX_VALUE)

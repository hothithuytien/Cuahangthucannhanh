...
//        setButtonStates(true, false, false, false);    
    ...
    public void loadTable() {
       ...
       java.util.List<DTO.CustomerDTO> list = customerBus.disPlayListCustomer();
       for(DTO.CustomerDTO kh : list){
    ...
    private void addCustomer(){
        if(validataForm()){
            DTO.CustomerDTO kh = getCustomerFromForm();
...
//                setButtonStates(true, false, false, false);
   ...
   private void searchByComboChoice() {
    ...
    if (type.equals("Tìm theo mã")) {
            DTO.CustomerDTO kh = customerBus.findKhachHangById(keyword);
        if (kh != null) {
            model.addRow(new Object[]{
                kh.getMAKH(),
                kh.getHOTENKH(),
        ...
        java.util.List<DTO.CustomerDTO> list = customerBus.searchKhachhangByName(keyword);
        for (DTO.CustomerDTO kh : list) {
            model.addRow(new Object[]{
               kh.getMAKH(),
                kh.getHOTENKH(),
    ...
    private DTO.CustomerDTO getCustomerFromForm(){
        String MAKH = txtmakh.getText();
        String HOTENKH = txttenkh.getText();
        String GIOITINH = nam.isSelected() ? "Nam" : "Nu";
        String SDT =  txtsdt.getText();
        String DIACHI = txtdc.getText();
        return new DTO.CustomerDTO(MAKH, HOTENKH, GIOITINH, SDT, DIACHI);
    }
...
//        txtmakh.setEnabled(true);
    ...
    private void initComponents() {
        ...
        btnxoakh.setFont(new java.awt.Font("Segoe UI", 1, 13)); // NOI18N
        ...
        btnsuakh.setFont(new java.awt.Font("Segoe UI", 1, 13)); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(tfsearch, javax.swing.GroupLayout.PREFERRED_SIZE, 124, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(btnxoakh, javax.swing.GroupLayout.Alignment.TRAILING)))
                            .addGroup(jPanel2Layout.createSequentialGroup()

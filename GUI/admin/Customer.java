...
public class Customer extends javax.swing.JPanel {
    ...
    private void updateCustomer (){
        if(validataForm()){
            ...
            if(customerBus.updateCustomer(kh)){
                JOptionPane.showMessageDialog(this,"Cap nhap khach hang thanh cong");
                clearForm();
                loadTable();
                isEditing = false;
                setButtonStates(true, false, false, false);
            }else{
                JOptionPane.showMessageDialog(this, "Cap nhat khach hang that bai!","Loi" ,JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    private void deleteCustomer (){
        ...
        if(!makh.isEmpty()){
            int confirm = JOptionPane.showConfirmDialog(this,"Ban co chac chan muon xoa khach hang?","Xac nhan", JOptionPane.YES_NO_OPTION);
            if(confirm == JOptionPane.YES_OPTION){
                if (customerBus.deleteCustomer(makh)){
                    JOptionPane.showMessageDialog(this,"Xoa khach hang thang cong!");
                    clearForm();
                    loadTable();
                }
                else{
                    JOptionPane.showMessageDialog(this,"Xoa khach hang that bai", "loi", JOptionPane.ERROR_MESSAGE);
                }
            }else{
                    JOptionPane.showMessageDialog(this,"Vui long chon khach hang can xoa", "loi", JOptionPane.ERROR_MESSAGE);
                }
        }  
    }
    ...
    private void searchCustomerById(){
        ...
        if(!makh.isEmpty()){
            ...
            if( kh != null){
                ...
                JOptionPane.showMessageDialog(null, "Không tìm thấy khach hang với mã: " + makh);
            }
        }else{
            loadTable();
        }
    ...
    private boolean validataForm(){
        if (txtmakh.getText().isEmpty()){
            JOptionPane.showMessageDialog(this, "Vui long nhap ma khach hang", "Loi", JOptionPane.ERROR_MESSAGE);
            txtmakh.requestFocus();
            return false;
        }
        if(txttenkh.getText().isEmpty()){
            JOptionPane.showMessageDialog(this,"Vui long nhap ten khach hang","Loi", JOptionPane.ERROR_MESSAGE);
            txttenkh.requestFocus();
            return false;
        }
        if (!nam.isSelected() && !nu.isSelected()){
            JOptionPane.showMessageDialog(this, "Vui long chon gioi tinh", "loi", JOptionPane.ERROR_MESSAGE);
            return false;
        }
        if(!txtsdt.getText().matches("\\d{10,11}")){
            JOptionPane.showMessageDialog(this, "Vui long nhap so dien thoai pha co 10-11 chu so", "Loi", JOptionPane.ERROR_MESSAGE);
            txtsdt.requestFocus();
            return false;
        }
        if(txtdc.getText().isEmpty()){
           JOptionPane.showMessageDialog(this, "Vui long nhap dia chi", "loi", JOptionPane.ERROR_MESSAGE);
           txtdc.requestFocus();
            return false; 
        }
        return true;
...
//        txtmakh.setEnabled(true);
    ...
    private void initComponents() {
        ...
        btnthemkh.setFont(new java.awt.Font("Times New Roman", 1, 15)); // NOI18N
        ...
        btnxoakh.setFont(new java.awt.Font("Times New Roman", 1, 15)); // NOI18N
        ...
        btnsuakh.setFont(new java.awt.Font("Times New Roman", 1, 15)); // NOI18N
        ...
        jPanel1.add(jPanel4);
        jPanel4.setBounds(0, 200, 1300, 550);

        add(jPanel1);
        jPanel1.setBounds(0, 0, 1310, 750);
...
//        txtngs.setText(tableCustomer.getValueAt(row, 6).toString());
    ...
    private void btnsuakhActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsuakhActionPerformed
        if(!txtmakh.getText().isEmpty()){
            ...
            JOptionPane.showMessageDialog(this, "Vui long chon khach han can sua", "Loi", JOptionPane.ERROR_MESSAGE);
        }

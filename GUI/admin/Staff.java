...
//                setButtonStates(true, false, false, false);
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel1);
        jLabel1.setBounds(460, 10, 190, 25);
        ...
        jPanel2.add(txtmanv);
        txtmanv.setBounds(250, 40, 100, 20);

        jLabel3.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel3.setText("Tên nhân viên");
        jPanel2.add(jLabel3);
        jLabel3.setBounds(380, 40, 90, 20);
        ...
        txthotennv.setBounds(490, 40, 100, 23);

        jLabel4.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel4.setText("Ngày sinh");
        jPanel2.add(jLabel4);
        jLabel4.setBounds(620, 40, 70, 20);
        ...
        jPanel2.add(txtngs);
        txtngs.setBounds(690, 40, 100, 23);

        jLabel5.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel5.setText("Số điện thoại");
        jPanel2.add(jLabel5);
        jLabel5.setBounds(380, 90, 100, 20);
        ...
        jPanel2.add(txtsdt);
        txtsdt.setBounds(490, 90, 100, 23);

        jLabel6.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel6.setText("Địa chỉ");
        jPanel2.add(jLabel6);
        jLabel6.setBounds(620, 90, 50, 20);
        ...
        btnthemnv.setBounds(190, 130, 75, 30);
        ...
        btnxoanv.setBounds(310, 130, 72, 30);
        ...
        btnsuanv.setBounds(430, 130, 72, 30);
        ...
        jPanel2.add(btnluu);
        btnluu.setBounds(550, 130, 72, 30);
        ...
        jPanel2.add(btnhuy);
        btnhuy.setBounds(670, 130, 72, 30);
        ...
        nu.setText("Nữ");
        jPanel2.add(nu);
        nu.setBounds(250, 100, 70, 25);

        jLabel7.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel7.setText("Giới tính");
        jPanel2.add(jLabel7);
        jLabel7.setBounds(140, 90, 90, 20);
        ...
        tfsearch.setBounds(760, 170, 150, 22);
